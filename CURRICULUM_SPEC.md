...
(August 2026):** OpenAI's unreleased **Astra** model — teased August 1 via
ten machine-checked proofs of decade-open math/theoretical-CS problems,
each with a Lean 4 certificate — is described as coordinating multiple
agents over long-horizon tasks, making it a concrete, citable example of
where the test-time-compute scaling axis is headed beyond single-pass
best-of-N.
